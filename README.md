...
3. **Prometheus + Grafana 기반 병목 지점 모니터링 및 지속적인 성능 개선**  <br>
<br>
...
<h2 align="center"> 2. Full Table Scan 제거를 통한 성능 개선 (TPS 최대 133% 향상) </h2>
...
- **주요 개선 포인트**
  - **video_view_history, settlement_result, top5_statistics**에 복합 인덱스 적용
  - Docker 환경에서 **단일 SSD를 공유**하는 구조적 특성으로 인해,  
    Full Table Scan 제거 → Disk IO 병목 해소 → **전체 서비스 성능 동시 개선**
  - **모니터링 지표로 IO 대기 시간 및 TPS 상승 확인**
